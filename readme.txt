...
5 .in run function server waits for a command in a while loop and client write string command ,comes from bufferreader, and server read commands and call our function!
6 .in functions sth like 5 happen
